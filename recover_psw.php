    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            // h-hotel account
            $mail->Username='waliddabbaghi5@gmail.com';
            $mail->Password='rwzicrnjnoxlrxim';

            // send by h-hotel email
            $mail->setFrom('waliddabbaghi5@gmail.com', 'Password Reset');
            ...
            http://localhost/login_system/reset_psw.php
            <br><br>
            <p>With regrads,</p>
